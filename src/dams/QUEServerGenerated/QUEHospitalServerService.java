 ...
 * 
 */
@WebServiceClient(name = "QUEHospitalServerService", targetNamespace = "http://server.dams/", wsdlLocation = "file:/C:/Users/mauli/Desktop/MACS/COMP%206231%20-%20Distributed%20System%20Design/Assignments/DAMS%20-%20Web%20Service/src/dams/server/QuebecWSDL.wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUEHOSPITALSERVERSERVICE_QNAME = new QName("http://server.dams/", "QUEHospitalServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/mauli/Desktop/MACS/COMP%206231%20-%20Distributed%20System%20Design/Assignments/DAMS%20-%20Web%20Service/src/dams/server/QuebecWSDL.wsdl");
    ...
    public QUEHospitalServer getQUEHospitalServerPort() {
        return super.getPort(new QName("http://server.dams/", "QUEHospitalServerPort"), QUEHospitalServer.class);
    }
    ...
    public QUEHospitalServer getQUEHospitalServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.dams/", "QUEHospitalServerPort"), QUEHospitalServer.class, features);
    }
